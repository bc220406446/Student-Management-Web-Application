...
<form method="POST">
    <div class="admin-panel-body">
        <h3 class="admin-section-title mb-3">Personal Information</h3>
        <div class="row">
        ...
        <h3 class="admin-section-title mb-3 mt-3">Change Password</h3>
    ...
    <div class="admin-panel-footer"><a href="dashboard.php" class="btn btn-outline">Cancel</a><button class="btn btn-primary" type="submit">Save Changes</button></div>
</form>
</div>
